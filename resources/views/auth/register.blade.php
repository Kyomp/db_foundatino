<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4 flex items-center space-x-5 space-between">
                <div class="block mt-1 w-5/6">
                    <x-label for="dob" value="{{ __('Date Of Birth') }}" />
                    <x-input id="dob" class="w-full" type="date" name="dob" :value="old('dob')" required />
                </div>
                <div class="block mt-1 w-1/6">
                    <x-label for="foreigner" value="{{ __('Foreigner') }}" />
                    <x-checkbox id="foreigner" name="foreigner"/>
                </div>
            </div>
