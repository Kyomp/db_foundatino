<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ url('/foreigner') }}">
            @csrf

            <div>
                <x-label for="passport_no" value="{{ __('Passport No.') }}" />
                <x-input id="passport_no" class="block mt-1 w-full" type="text" name="passport_no" :value="old('email')" required  />
            </div>
            ...
            <div class="mt-4">
                <x-label for="issued_at" value="{{ __('Issuing Office') }}" />
                <x-input id="issued_at" class="block mt-1 w-full" type="text" name="issued_at" required  />
            </div>
